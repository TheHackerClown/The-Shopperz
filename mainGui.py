...
#icon for button
clearimgnot = tk.PhotoImage(file='IMG_Data/clear.png')
clearimg = clearimgnot.subsample(5,5)

exitimgnot = tk.PhotoImage(file='IMG_Data/exit.png')
exitimg = exitimgnot.subsample(5,5)

addimgnot = tk.PhotoImage(file='IMG_Data/add.png')
addimg = addimgnot.subsample(5,5)

saveimgnot = tk.PhotoImage(file='IMG_Data/save.png')
